...
- [ ] Гейт корректности: + integration-тест (ClickHouse) и tail-тесты (после появления follow-режима)
- [ ] Официальные серии замеров по протоколу (bench-medium 5.4 ГБ, чистая машина → финалисты на полных 175 ГБ)
